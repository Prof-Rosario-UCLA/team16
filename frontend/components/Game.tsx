...
export default function Game({ gameId }: { gameId: string }) {
  ...
  return (
  <div className="relative flex flex-col flex-1 items-center p-8 h-[100vh] w-[100vw] bg-blue-200 gap-2 overflow-hidden">
    {/* Overlay */}
    {showInfo && (
    ...
    {/* Top bar */}
    <div className="flex flex-row items-center w-full justify-center z-10 m-10">
      {!gameStarted ? (
        ...
        <div className="text-center text-lg font-bold">
          ...
          {user?.username === currDrawer && (
            ...
            <span className= "text-sm nes-text is-primary"> {currWord}</span>
            </>
